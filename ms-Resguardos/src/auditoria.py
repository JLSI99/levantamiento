...
def auditar_antes_de_flush(session, flush_context, instances):
    ...
    # --- ENRUTAMIENTO DE OPERACIONES (INSERT) ---
    ...
    # --- ENRUTAMIENTO DE OPERACIONES (UPDATE) ---
    for obj in session.dirty:
        ...
        for prop in obj.__mapper__.column_attrs:
            ...
            if history.has_changes():
                ...
                if isinstance(viejo, decimal.Decimal): viejo = float(viejo)
                if isinstance(nuevo, decimal.Decimal): nuevo = float(nuevo)
    ...
    # --- ENRUTAMIENTO DE OPERACIONES (DELETE) ---
